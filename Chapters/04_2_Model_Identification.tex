...
\newpage
\subsection{Model Computation: Semi-Parametric Gaussian Process Regression}
...
\begin{figure}[h!]
    ...
    \caption{Gaussian Process Regression \cite{GPR}}
    \label{fig:GPR}
\end{figure}
...
In the following sections, the code and the corresponding mathematical implications will be detailed.  Refer to figure \ref{fig:ModelComputationGPR} for a detailed flow diagram.
